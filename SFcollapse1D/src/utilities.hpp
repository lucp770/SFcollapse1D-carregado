...
namespace utilities {
  ...
  real random_search_negative_values(real , real ,  real , real ,  real, real);
 
  real random_search_positive_values(real , real , real, real, real, real);

  void generate_plot_for_bissection(real , real , real , real , real , real);
